...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-06-2016 a las 21:44:32
...
(2, 'Ariel Brayan', 'Ferrel ', 'Salvatierra', 4432412, 77902769, 'arielbrayan22@gmail.com', 'av. Simon Lopez y av. Colquiri Sud');
...
(2, 'INTRODUCCION A LA PROGRAMACION', 2001020, '1', 'A', '24 hrs/mes', 'ELEMENTOS DE PROGRAMACION Y ESTRUCTURA DE DATOS,TALLER DE PROGRAMACION Y ESTRUCTURA DE DATOS', 1),
(3, 'ELEMENTOS DE PROGRAMACION Y ESTRUCTURA DE DATOS', 2001030, '1', 'B', '24 hrs/mes', 'BASE DE DATOS I,TALLER DE PROGRAMACION Y ESTRUCTURA DE DATOS', 1),
...
INSERT INTO `objetivo` (`ID_Objetivo`, `Clave_Objetos`, `ID_PG`) VALUES
(1, 1, 1);
...
CREATE TABLE `objetivos` (
  `ID_Objetivo` int(11) NOT NULL,
  `Clave_Objetivo` int(11) NOT NULL,
...
INSERT INTO `objetivos` (`ID_Objetivo`, `Clave_Objetivo`, `Texto_Obj`) VALUES
...
(1, 'Introducción a las Gráficas por Computadora', 1),
(2, 'Aplicaciones', 1),
...
(6, 'knskjnfkjsNkjsfn', 3),
(7, 'lkfmslkmflksmdlkdms', 3);
...
(1, 'INTRODUCCIÓN A LAS GRÁFICAS POR COMPUTADORA', 1, 3),
...
--
ALTER TABLE `justificacion`
  MODIFY `Id_Justificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `planglobal`
  MODIFY `ID_PG` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
